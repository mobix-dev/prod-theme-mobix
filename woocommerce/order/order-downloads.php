...
<div class="woocommerce-order-downloads">
	<?php if ( isset( $show_title ) ) : ?>
		<div class="h3 woocommerce-order-downloads__title"><?php esc_html_e( 'Downloads', 'woocommerce' ); ?></div>
	<?php endif; ?>
						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file button alt button--small button--text">' . esc_html( $download['download_name'] ) . '</a>';
									break;
